...
7. Power up the driver and connect it with micro usb port (its near the RJ45 port). Click Run->Run or click the green arrow icon to build and flash the device.
  - Alternatively you can select Project->Build Project and then copy manually the file in Debug/stepper2.bin to the mass storage device that opens after conneting the driver. 
